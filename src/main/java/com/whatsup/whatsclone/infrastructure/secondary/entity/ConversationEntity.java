...
import com.whatsup.whatsclone.infrastructure.secondary.entity.ConversationEntityBuilder;
import com.whatsup.whatsclone.messaging.domain.message.aggregate.ConversationBuilder;
...
public class ConversationEntity extends AbstractAuditingEntity<Long> {
    ...
    public static ConversationEntity from(Conversation conversation){
        ...
        if(conversation.getMessages() != null){
           Set<MessageEntity> message = conversation.getMessages().stream()
                    .map(MessageEntity::from).collect(Collectors.toSet());
    ...
    public static Conversation toDomain(ConversationEntity conversation) {
        ...
        // set of messages tj vise poruka od jednom ako zelimo dobiti
        if (conversation.getMessages() != null) {
