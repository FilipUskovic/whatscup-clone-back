...
import com.whatsup.whatsclone.shared.jpa.AbstractAuditingEntity;
...
public class UserEntity extends AbstractAuditingEntity<Long> {
    ...
    // manange sequence unutar data base-a
    ...
    public UserEntity(Long id, String lastName, String firstName, String email, String imageUrl,
                      UUID publicId, Instant lastSeen, Set<AuthorityEntity> authorities, Set<ConversationEntity> conversations) {
        this.id = id;
    ...
    // converzacija from User to user entity
    public static UserEntity from(User user){
        ...
        // kada znamo da publicId nijie null i imao sliku mozemo mapirati i druge
    ...
    public static User toDomain(UserEntity userEntity){
        ...
        if(userEntity.imageUrl != null){
                        // kreiramo novu i kopiramo vrijednost
    ...
    // direktno saljemo nazad set user entitija
